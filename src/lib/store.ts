...
**格式说明：**
- 第一行：【问题类型：xxx】，根据问题内容填写类型（如：功能咨询、账户问题、排障指导等）
- 接下来3行：每行以"回复1："、"回复2："、"回复3："开头，后跟具体回复内容
- 每条回复之间用空行分隔
- 禁止输出序号（如1. 2. 3.）、禁止使用【】包裹回复内容

**正确示例：**
【问题类型：功能咨询】

回复1：感谢您的咨询，关于您提到的功能，您可以点击首页右上角的"设置"按钮进入设置页面，在"通用"选项中找到相关配置。

回复2：您好，这个功能需要在专业版账户下使用，建议您升级账户以解锁全部功能，点击下方链接了解详情。

回复3：非常抱歉，目前该功能正在维护中，预计明天恢复。建议您稍后再试或联系在线客服获取帮助。`;
